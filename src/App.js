...
import './App.css';
import Todo from './Components/NewTodo/NewTodo';
import TodoUpdater from './Components/TodoUpdater/TodoUpdater';
...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <TodoUpdater change={(event)=>{this.changeTaskName(event)}} taskName={this.state.taskName} click={(event)=>{this.addTodo(this.state.taskName)}} enterPressed={(event)=>this.keyPressed(event)}/>
        <ul>
          {myTodos}
        </ul>
      </div>
